...
exports.create = (user) => db.execute(
  "INSERT INTO users (uuid, full_name, email, phone, password_hash, role) VALUES (?, ?, ?, ?, ?, ?)",
  [user.uuid, user.fullName, user.email, user.phone || null, user.passwordHash, user.role || "user"]
);
